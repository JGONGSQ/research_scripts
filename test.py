...
# data_duration_counts = np.zeros(number_of_alternatives)
# data_alternative_counts = np.zeros(number_of_alternatives)
# data_number_of_choosen_alternative_counts = np.zeros(number_of_alternatives)
...
plot_bar_graph_within(STATE_LISTS, data_duration_counts, result_duration_counts, 'Duration counts in days')
plot_bar_graph_within(STATE_LISTS, data_alternative_counts, result_alternative_counts, 'Alternative counts as hit ratio')
plot_bar_graph_within([1,2,3,4,5,6], data_number_of_chosen_alternative_counts, result_number_of_chosen_alternative_counts, "Number of chosen alternative hit")
